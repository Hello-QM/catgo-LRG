...
MLP_NODES = {"mlp_relax", "mlp_md", "mlp_vibrations", "mlp_single_point", "mlp_neb"}
...
# HPC analysis nodes — analysis that requires HPC resources (heavy post-processing)
HPC_ANALYSIS_NODES: set[str] = {"bader_analysis"}
