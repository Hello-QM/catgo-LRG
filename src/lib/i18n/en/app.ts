...
const app: Record<string, string> = {
  ...
  select_all_deletable_workflows: `Select all deletable`,
  workflows_selected: `{count} selected`,
  clear_selection: `Clear`,
  delete_selected_workflows: `Delete selected`,
  deleting_workflows: `Deleting...`,
  workflow_deleted: `Deleted workflow “{name}”.`,
  workflows_deleted: `Deleted {count} workflows.`,
  and_more_workflows: `...and {count} more`,
  stop_workflow_before_delete: `This workflow still has active execution tasks. Pause it before deleting.`,
