...
export const SETTINGS_CONFIG: SettingsConfig = {
  ...
  structure: {
    ...
    depth_cueing: {
      value: 0.15,
      description: `Depth cueing intensity (0 = off, 1 = maximum). Fades distant atoms toward the background color to convey depth.`,
      minimum: 0,
      maximum: 1,
    },
    depth_cue_start: {
      value: 0,
      description: `Starting depth for depth cueing as fraction of structure extent (0 = front face, 1 = back face). Atoms closer than this are unaffected.`,
      minimum: 0,
      maximum: 1,
    },
    depth_cue_end: {
