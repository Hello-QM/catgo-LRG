...
export default defineConfig({
  title: `CatGO`,
  description: `Interactive visualization toolkit for materials science and computational chemistry`,
  lang: `en-US`,
  ...
  themeConfig: {
      ...
      { text: `Tutorials`, link: `/tutorials/basics/getting-started` },
      {
        ...
        items: [
          ...
          },
          {
            text: `Analysis`,
            items: [
              { text: `Electronic Structure`, link: `/modules/electronic/band-structure` },
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { text: `Database Search`, link: `/tutorials/structures/database-search` },
              ],
            },
            {
              text: `Visualization`,
              collapsed: false,
              items: [
                { text: `Density Visualization`, link: `/tutorials/visualization/density-viz` },
            ...
            },
            {
              ...
              items: [
                ...
                { text: `H-Bond Detection`, link: `/tutorials/md-analysis/hbond-detection` },
                { text: `Clustering & PCA`, link: `/tutorials/md-analysis/clustering-pca` },
              ],
            },
            {
              text: `AI Features`,
            ...
            },
            {
              ...
              collapsed: false,
              items: [
                { text: `Gesture & Hand Tracking`, link: `/tutorials/interaction/gesture-hand-tracking` },
      ...
      "/modules/": [
        {
          ...
          items: [
            ...
            },
            {
              ...
              collapsed: false,
              items: [
                { text: `Surfaces & Slabs`, link: `/modules/crystallography/surfaces-slabs` },
            ...
            },
            {
              ...
              items: [
                ...
                { text: `Project Dashboard`, link: `/modules/workflow/project-dashboard` },
              ],
            },
            {
              text: `AI & Language`,
            ...
            },
            {
              ...
              collapsed: false,
              items: [
                { text: `Density Visualization`, link: `/modules/integrations/density-visualization` },
                { text: `Database Integration`, link: `/modules/integrations/database-integration` },
              ],
            },
            {
              text: `Server`,
    ...
    socialLinks: [
      { icon: `github`, link: `https://github.com/Hello-QM/CatGO` },
    ],
    ...
    editLink: {
      pattern: `https://github.com/Hello-QM/CatGO/edit/main/docs/:path`,
